angular
    ...
    .config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider
            ...
            .state('games', {
                url: '/Games',
                templateUrl: '/app/components/games/games.htm',
            ...
            .state('file-manager', {
                url: '/FileManager',
                templateUrl: '/app/components/fileManager/fileManager.htm',
            ...
            .state('diagnostics', {
                url: '/Diagnostics',
                templateUrl: '/app/components/diagnostics/diagnostics.htm',
            ...
            .state('datalogger', {
                url: '/DataLogger',
                templateUrl: '/app/components/datalogger/datalogger.htm',
                controller: 'dataloggerCtrl',
                data: {
                    NeedsAdmin: false,
                    NeedsLogin: true,
                    AllowGuest: true
