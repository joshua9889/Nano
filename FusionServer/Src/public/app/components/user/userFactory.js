angular
    ...
    .factory('userFactory', ['$http', 'appFactory', '$state', '$window', function ($http, appFactory, $state, $window) {
        ...
        // Get all guest users
        User.GetAllGuests = function () {
            return $http.get('/api/guestUsers')
                .then(function (response) {
                    return response.data;
                }, function(error) {
                    return error;
        ...
        // Delete Specific Guest User
        User.DeleteGuest = function (UserId) {
            return $http.delete('/api/guestUsers/' + UserId)
                .then(function (response) {
                    appFactory.showToast(response.data.serverMessage, 'success');
                    return response.data;
                }, function (error) {
