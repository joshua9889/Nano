        ...
        '<md-toolbar class="md-menu-toolbar" ng-cloak>' +
            '<div layout="row">' +
                    ...
                    '<div>' +
                        '<md-menu-bar>' +
                            '<md-menu>' +
                                ...
                                '<md-menu-content>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="NewBlocklyFile()"><div translate="BLOCKLY.MENUBAR_FILE_NEW"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="OpenFileDialog(ev)"><div translate="BLOCKLY.MENUBAR_FILE_OPEN"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="NewBlocklyFile()"><div translate="BLOCKLY.MENUBAR_FILE_CLOSE"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-divider></md-menu-divider>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="SaveBlocklyFile()"><div translate="BLOCKLY.MENUBAR_FILE_SAVE"></div></md-button>' +
                                   ' </md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="SaveAsDialog(ev)"><div translate="BLOCKLY.MENUBAR_FILE_SAVE_AS"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-divider></md-menu-divider>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="DeleteDialog(ev)"><div translate="BLOCKLY.MENUBAR_FILE_DELETE"></div></md-button>' +
                                    '</md-menu-item>' +
                                '</md-menu-content>' +
                            '</md-menu>' +
                            '<md-menu>' +
                                ...
                                '<md-menu-content>' +
                                    '<md-menu-item class="md-indent">' +
                                        '<md-menu>' +
                                            '<md-button ng-click="$mdMenu.open()"><div translate="BLOCKLY.MENUBAR_VIEW_MODE"></div></md-button>' +
                            ...
                            '<md-menu>' +
                                ...
                                '<md-menu-content>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="UploadFilesDialog()"><div translate="BLOCKLY.MENUBAR_MANAGE_IMPORT"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="DownloadFilesDialog()"><div translate="BLOCKLY.MENUBAR_MANAGE_EXPORT"></div></md-button>' +
                                    '</md-menu-item>' +
                                '</md-menu-content>' +
                            '</md-menu>' +
                            '<md-menu>' +
                                ...
                                '<md-menu-content>' +
                                    examplesHtml +
                                    '<md-menu-item>' +
                                            '<md-button ng-click="takeToBlocklyDocs()"><div translate="BLOCKLY.MENUBAR_HELP_DOCUMENTATION"></div></md-button>' +
                                        '</md-menu-item>' +
                                    '</md-menu-content>' +
                                '</md-menu>' +
                            '</md-menu-bar>' +
                ...
                '<div class="fusion-ribbon">' +
                    '<md-button class="fusion-ribbon-button tooltip" ng-click="NewBlocklyFile()">' +
                    ...
                    '</md-button>' +
                    // '<md-button class="fusion-ribbon-button" ng-click="openInEditor()">' +
    ...
    function eachRecursive(obj) {
        ...
        if (obj.type == 'directory') {
            ...
            if (obj.name == 'Examples') {
                ...
                examplesHtml += '<md-button ng-click="$mdMenu.open()"><div translate="BLOCKLY.MENUBAR_HELP_EXAMPLES"></div></md-button>';
