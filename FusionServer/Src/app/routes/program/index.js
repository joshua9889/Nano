            ...
            '<md-toolbar class="md-menu-toolbar">' +
                    ...
                    '<div class="fusion-toolbar">' +
                        ...
                        '<md-menu-bar>' +
                            '<md-menu>' +
                                ...
                                '<md-menu-content>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="CreateNewWorkspaceFile()"><div translate="EDITOR.MENUBAR_FILE_NEW"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="OpenFileDialog(ev)"><div translate="EDITOR.MENUBAR_FILE_OPEN"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="CloseFile(SelectedFile)"><div translate="EDITOR.MENUBAR_FILE_CLOSE"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-divider></md-menu-divider>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="SaveFileDialog()"><div translate="EDITOR.MENUBAR_FILE_SAVE"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="SaveAsDialog(ev)"><div translate="EDITOR.MENUBAR_FILE_SAVE_AS"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="SaveAllDialog()"><div translate="EDITOR.MENUBAR_FILE_SAVE_ALL"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-divider></md-menu-divider>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="DeleteDialog(ev)"><div translate="EDITOR.MENUBAR_FILE_DELETE"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-divider></md-menu-divider>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="PrintDialog()"><div translate="EDITOR.MENUBAR_FILE_PRINT"></div></md-button>' +
                                    '</md-menu-item>' +
                                '</md-menu-content>' +
                            '</md-menu>' +
                            '<md-menu>' +
                                ...
                                '<md-menu-content>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="UploadFilesDialog()"><div translate="EDITOR.MENUBAR_MANAGE_IMPORT"></div></md-button>' +
                                    '</md-menu-item>' +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="DownloadFilesDialog()"><div translate="EDITOR.MENUBAR_MANAGE_EXPORT"></div></md-button>' +
                                    '</md-menu-item>' +
                                '</md-menu-content>' +
                            '</md-menu>' +
                            '<md-menu>' +
                                '<button ng-click="$mdMenu.open()" class="fusion-toolbar-item" translate="EDITOR.MENUBAR_HELP">Help</button>' +
                                '<md-menu-content>' +
                                    examplesHtml +
                                    '<md-menu-item>' +
                                        '<md-button ng-click="takeToEditorDocs()"><div translate="EDITOR.MENUBAR_HELP_DOCUMENTATION"></div></md-button>' +
                                    '</md-menu-item>' +
                                '</md-menu-content>' +
                            '</md-menu>' +
                        '</md-menu-bar>' +
                ...
                '<div class="fusion-ribbon">' +
                    ...
                    '<md-button class="fusion-ribbon-button" ng-click="SaveAllDialog()">' +
                        ...
                        '</span>' +
                    '</md-button>' +
                    '<md-button class="md-primary fusion-ribbon-button" ng-click="RunExistingEditorFile()">' +
                        '<md-tooltip><div translate="EDITOR.TOOLBAR_RUN_FILE_TOOLTIP"></div></md-tooltip>' +
                        '<i class="fas fa-play fa-lg fa-fw"></i>' +
                    '</md-button>' +
                    '<md-button class="md-warn fusion-ribbon-button" ng-click="StopRunningEditorFile()">' +
                        '<md-tooltip><div translate="EDITOR.TOOLBAR_STOP_FILE_TOOLTIP"></div></md-tooltip>' +
                        '<i class="fas fa-stop fa-lg fa-fw"></i>' +
                    '</md-button>' +
                    '<md-button class="fusion-ribbon-button" ng-click="OpenVirtualGamepad()" ng-disabled="DisableVirtualGamepad()">' +
    ...
    function eachRecursive(obj) {
        ...
        if (obj.type == 'directory') {
            ...
            if (obj.name == 'Examples') {
                ...
                examplesHtml += '<md-button ng-click="$mdMenu.open()"><div translate="EDITOR.MENUBAR_HELP_EXAMPLES"></div></md-button>';
