...
#
# Revision History:
#	12-May-2020 <jwa> - Fixed various typos and enhanced the comments
#   26-Mar-2020 <jwa> - Modified Stage 7 (Final Clean-up) to remove the 
#       EngrDocs folder since we do not want this to be included in the
#       FusionRT distribution
...
#       26-Mar-2020 <jwa> added EngrDocs to files being removed
#
...
#   update.sh
rm -r docsrc EngrDocs ref temp .unused
...
GIT_COMMIT="Version ID: $(cat version.txt)  [ Dev: ${DEV_BRANCH}, RT: ${RT_BUILDID} ]"
