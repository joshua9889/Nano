'''
testController.py - Test joystick using GUI Interface via VNC desktop
    (c) Modern Robotics Inc. 2017  http://www.modernroboticsinc.com

Description:
    Use the following example within the desktop environment to see the full
    output of all axis and buttons of the connected gamepad or joystick via a 
...
# This is a simple class that will help us printf to the screen
