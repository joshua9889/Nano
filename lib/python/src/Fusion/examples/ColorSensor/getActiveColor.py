'''
getActiveColor.py - Return the color of an object using active mode
    (c) Modern Robotics Inc. 2017  http://www.modernroboticsinc.com

Description:
    The following example uses an MRI Touch Sensor and Color Sensor
    to read and return all color readings of an object. Pressing the 
    Touch sensor button will take one reading per press. 
